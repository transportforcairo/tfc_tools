...
class TfCToolsAlgorithm(QgsProcessingAlgorithm):
    def icon(self):
        """Return the icon for the Processing Toolbox"""
        icon_path = os.path.join(os.path.dirname(__file__), "icons", "GIS-icon.svg")
